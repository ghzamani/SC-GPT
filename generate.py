...
ALL_MODELS = sum((conf for conf in (GPT2Config.get_config_dict("gpt2"), OpenAIGPTConfig.get_config_dict("openai-gpt"), XLNetConfig.get_config_dict("xlnet-base-cased"), TransfoXLConfig.get_config_dict("transfo-xl-wt103"), XLMConfig.get_config_dict("xlm-roberta-base"), CTRLConfig.get_config_dict("ctrl"), T5Config.get_config_dict("t5-base"))), ())
...
def main():
    ...
    output_tests = []
    for idx in tqdm(range(0, len(inputs), 1), total = len(inputs)):
