...
def train(args, train_dataset, model, tokenizer):
    ...
    for e in range(int(args.num_train_epochs)):
        ...
        epoch_iterator = tqdm(enumerate(train_dataloader), desc=f"{e+1} / {int(args.num_train_epochs)} Epoch", disable=args.local_rank not in [-1, 0], total = len(train_dataloader))
